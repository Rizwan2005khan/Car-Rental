    ...
    transition={{duration: 0.8}}
     className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
      ...
      transition={{duration: 0.6, delay: 0.4}}
       onSubmit={handleSearch} className='flex flex-col md:flex-row items-start items-center justify-between p-6 rounded-lg d:rounded-full w-full max-w-80 md:max-w-200 bg-white shadow-[0px,8px,20px,rgba(0,0,0.1)]'>
        <div className="flex flex-col md:flex-row items-start md:items-center gap-10 min-md:ml-8">
        <div className='flex flex-col items-start gap-2'>
            <select required={pickupLocation} onChange={(e) => setPickupLocation(e.target.value)}>
        ...
        <div className='flex flex-col items-start gap-2'>
            <label value={returnDate} onChange={e => setReturnDate(e.target.value)} htmlFor="return-date">Return Date</label>
