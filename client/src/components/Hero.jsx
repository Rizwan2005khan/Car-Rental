...
const Hero = () => {
  ...
  return (
    <div className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
      ...
      <form className='flex flex-col md:flex-row items-start items-center justify-between p-6 rounded-lg d:rounded-full w-full max-w-80 md:max-w-200 bg-white shadow-[0px,8px,20px,rgba(0,0,0.1)]'>
